              ...
              <Box sx={{ mt: 3, display: 'flex', gap: 1.5 }}>
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    const authorizeUrl = `${API_BASE_URL}/api/v1/auth/oauth/google/authorize?role=${formData.role}`;
                ...
                <Button
                  ...
                  onClick={() => {
                    const API_BASE_URL = process.env.REACT_APP_API_URL || 'http://localhost:8000';
                    const authorizeUrl = `${API_BASE_URL}/api/v1/auth/oauth/github/authorize?role=${formData.role}`;
                    window.location.href = authorizeUrl;
                  }}
                  sx={{
                    py: 1.5,
